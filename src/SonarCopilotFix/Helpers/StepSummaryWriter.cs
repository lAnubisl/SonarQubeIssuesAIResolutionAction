...
{
    public void Write(IRunSummary actionSummary)
    {
        ...
        [
            ...
            "",
            $"* SonarQube project: `{configurationHelper.SonarProjectKey}`",
        ...
        {
            foreach (IPullRequestResult result in actionSummary.PullRequestSummaries)
            {
        ...
        IPullRequestResult[] sessions = actionSummary.PullRequestSummaries
        ...
        {
            foreach (IPullRequestResult session in sessions)
            {
