    ...
    string Repository)
{
    public static ActionInputs FromEnvironment(IEnvironment environment)
    {
        ...
        return new ActionInputs(
            hostUri,
            projectKey,
            Csv(environment.Get("INPUT_COMPONENTS")),
            ...
            Csv(Trimmed(environment.Get("INPUT_STATUSES")) ?? "OPEN"),
            Csv(environment.Get("INPUT_SEVERITIES")),
            Csv(environment.Get("INPUT_IMPACT_SOFTWARE_QUALITIES")),
            Csv(environment.Get("INPUT_IMPACT_SEVERITIES")),
            Csv(environment.Get("INPUT_CLEAN_CODE_ATTRIBUTE_CATEGORIES")),
            Csv(environment.Get("INPUT_RULES")),
