...
public sealed class SonarCopilotFixApp : IApplication
{
    ...
    private readonly IEffortCalculator _effortCalculator;
        ...
        IEffortCalculator effortCalculator)
    {
        ...
        _github = github;
        _copilot = copilot;
        _effortCalculator = effortCalculator;
    }

    public async Task<int> RunAsync(CancellationToken cancellationToken = default)
    {
        IRunSummary summary = new ActionSummary(_effortCalculator);
        ...
        CancellationToken cancellationToken)
    {
        ...
        summary.RecordIssues(issues.TotalFound, issues.Issues);
        return issues;
    }

    private int CompleteWithoutIssues(IRunSummary summary)
    {
        _stepSummaryWriter.Write(summary);
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            IPullRequestResult pullRequestSummary = new PullRequestSummary(
                _effortCalculator,
                issueGroup,
                baseBranch,
                generatedBranch,
